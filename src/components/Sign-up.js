          ...
          if (user.password.length > 8) {
            if (user.password === user.confirmpassword) {
              Axios.post(`${process.env.React_App_Api_Url}/api/user/signup`, {
                ...
                .then((res) => {
                  toast.success(
                    "Your account has been successfully created. For verification an email has been sent to your account."
                  );
                  setloading(false);
            ...
            <div className="col-12 col-lg-6 sign-left">
              ...
              >
                ...
                <div className="remember-pass">
                  ...
                  <span>
                    Registration as an <Link to="/sign-up-manager">Agent</Link>
                  </span>
                </div>
              </form>
            </div>
